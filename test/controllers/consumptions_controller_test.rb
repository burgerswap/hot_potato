...
class ConsumptionsControllerTest < ActionController::TestCase
  ...
  test "should create consumption" do
    assert_difference('Consumption.count') do
      post :create, consumption: { leftover_id: @consumption.leftover_id, quantity: @consumption.quantity, user_id: @consumption.user_id }
    end
  ...
  test "should update consumption" do
    patch :update, id: @consumption, consumption: { leftover_id: @consumption.leftover_id, quantity: @consumption.quantity, user_id: @consumption.user_id }
    assert_redirected_to consumption_path(assigns(:consumption))
  end
